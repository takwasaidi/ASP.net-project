...
!function(e, t) {
    ...
    var i = function() {
      ...
      , l = function(e) {
        ...
        r.prototype.renderSegHtml = function(e, r) {
            var n, i, o = this.context, s = o.view, l = o.options, a = e.eventRange, d = a.def, c = a.ui, h = d.allDay, p = s.computeEventDraggable(d, c), u = h && e.isStart && s.computeEventStartResizable(d, c), f = h && e.isEnd && s.computeEventEndResizable(d, c), g = this.getSegClasses(e, p, u || f, r), m = t.cssToStr(this.getSkinCss(c)), y = "";
            return g.unshift("fc-day-grid-event", "fc-h-event"),
            e.isStart && (n = this.getTimeText(a)) && (y = '<span class="fc-time">' + t.htmlEscape(n) + "</span>"),
            i = '<span class="fc-title">' + (t.htmlEscape(d.title || "") || "&nbsp;") + "</span>",
            '<a class="' + g.join(" ") + '"' + (d.url ? ' href="' + t.htmlEscape(d.url) + '"' : "") + (m ? ' style="' + m + '"' : "") + '><div class="fc-content">' + ("rtl" === l.dir ? i + " " + y : y + " " + i) + "</div>" + (u ? '<div class="fc-resizer fc-start-resizer"></div>' : "") + (f ? '<div class="fc-resizer fc-end-resizer"></div>' : "") + "</a>"
        }
        ,
      ...
      , a = function(e) {
        ...
        r.prototype.renderSegRow = function(e, r) {
            var n, i, o, s, l, a, d, c = this.dayGrid, h = c.colCnt, p = c.isRtl, u = this.buildSegLevels(r), f = Math.max(1, u.length), g = document.createElement("tbody"), m = [], y = [], v = [];
            function b(e) {
                for (; o < e; )
                    (d = (v[n - 1] || [])[o]) ? d.rowSpan = (d.rowSpan || 1) + 1 : (d = document.createElement("td"),
                    s.appendChild(d)),
                    y[n][o] = d,
                    v[n][o] = d,
                    o++
            ...
            for (n = 0; n < f; n++) {
                ...
                i)
                    for (l = 0; l < i.length; l++) {
                        ...
                        w !== S ? d.colSpan = S - w + 1 : v[n][o] = d; o <= S; )
                            y[n][o] = d,
                            m[n][o] = a,
                            o++;
                        s.appendChild(d)
    ...
    var h = function(e) {
      ...
      , p = function(e) {
        ...
        r.prototype.renderFillRow = function(e, r) {
            var n, i, o, s = this.dayGrid, l = s.colCnt, a = s.isRtl, d = a ? l - 1 - r.lastCol : r.firstCol, c = (a ? l - 1 - r.firstCol : r.lastCol) + 1;
            ...
            return h && (s.isRtl ? t.appendToElement(o, h) : t.prependToElement(o, h)),
            i
        }
        ,
        r
    ...
    var y = t.createFormatter({
      ...
      , b = function(e) {
        function r(r, n, i) {
            ...
            o.renderDateSelection = t.memoizeRendering(l.renderSegs.bind(l, "highlight"), l.unrender.bind(l, "highlight"), [d]),
            o.renderBgEvents = t.memoizeRendering(l.renderSegs.bind(l, "bgEvent"), l.unrender.bind(l, "bgEvent"), [d]),
            o.renderFgEvents = t.memoizeRendering(s.renderSegs.bind(s), s.unrender.bind(s), [d]),
        ...
        r.prototype._renderCells = function(e, r) {
            ...
            this.colPositions = new t.PositionCache(this.el,this.cellEls.slice(0, a),!0,!1),
            n = 0; n < l; n++)
                for (i = 0; i < a; i++)
        ...
        r.prototype.renderNumberCellHtml = function(e) {
            var r, n, i = this.view, o = this.dateEnv, s = "", l = t.rangeContainsMarker(this.props.dateProfile.activeRange, e), a = this.getIsDayNumbersVisible() && l;
            return a || this.renderProps.cellWeekNumbersVisible ? ((r = t.getDayClasses(e, this.props.dateProfile, this.context)).unshift("fc-day-top"),
            this.renderProps.cellWeekNumbersVisible && (n = o.weekDow),
            s += '<td class="' + r.join(" ") + '"' + (l ? ' data-date="' + o.formatIso(e, {
                omitTime: !0
            }) + '"' : "") + ">",
        ...
        r.prototype.updateSize = function(e) {
            ...
            (e || this.isCellSizesDirty || this.view.calendar.isEventsUpdated) && (this.buildPositionCaches(),
        ...
        r.prototype.computeRowLevelLimit = function(e) {
            var r, n, i = this.rowEls[e].getBoundingClientRect().bottom, o = t.findChildren(this.eventRenderer.rowStructs[e].tbodyEl);
            for (r = 0; r < o.length; r++)
                if ((n = o[r]).classList.remove("fc-limited"),
        ...
        r.prototype.limitRow = function(e, r) {
            var n, i, o, s, l, a, d, c, h, p, u, f, g, m, y, v = this, b = this.colCnt, w = this.isRtl, S = this.eventRenderer.rowStructs[e], C = [], E = 0, R = function(n) {
                for (; E < n; )
                    (a = v.getCellSegs(e, E, r)).length && (h = i[r - 1][E],
        ...
        r.prototype.renderMoreLink = function(e, r, n) {
            ...
            return l.innerText = this.getMoreLinkText(n.length),
        ...
        r.prototype.showSegPopover = function(e, r, n, i) {
            var o, l, a = this, d = this.calendar, c = this.view, h = this.theme, p = this.isRtl ? this.colCnt - r - 1 : r, f = n.parentNode;
      ...
      , S = function(e) {
        function r(r, n, i, o) {
            ...
            s.opt("weekNumbers") ? s.opt("weekNumbersWithinDays") ? (a = !0,
        ...
        r.prototype.updateBaseSize = function(e, r, n) {
            ...
            ((o = this.scroller.getScrollbarWidths()).left || o.right) && (a && t.compensateScroll(a, o),
            i = this.computeScrollerHeight(r),
            this.scroller.setHeight(i)),
            this.scroller.lockOverflow(o))) : n || (i = this.computeScrollerHeight(r),
            this.scroller.setHeight(i))
        }
        ,
    ...
    var C = function(e) {
      ...
      , R = function(e) {
        function r(r, n, i, o) {
            var s = e.call(this, r, n, i, o) || this;
            return s.buildDayTable = t.memoize(H),
            s.opt("columnHeader") && (s.header = new t.DayHeader(s.context,s.el.querySelector(".fc-head-container"))),

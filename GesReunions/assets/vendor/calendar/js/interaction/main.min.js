...
!function(e, t) {
    ...
    var m = function() {
        ...
        e.prototype.handleMove = function(e, t) {
            ...
            !t && S(this.movingHit, n) || (this.movingHit = n,
            ...
            for (var a in r) {
                ...
                if (s.isWithinClipping(e, n)) {
                    ...
                    if (g >= 0 && g < p && u >= 0 && u < v) {
                        ...
                        !f || l.props.dateProfile && !t.rangeContainsRange(l.props.dateProfile.activeRange, f.dateSpan.range) || o && !(f.layer > o.layer) || (f.rect.left += c,
                        f.rect.right += c,
                        f.rect.top += d,
                        f.rect.bottom += d,
                        o = f)
        ...
        function n(n) {
            ...
            r.handleHitUpdate = function(e, n) {
                ...
                e && ((a = function(e, n, r) {
                    ...
                    s.allDay = o.allDay,
                    s
                }(r.hitDragging.initialHit, e, o.pluginSystem.hooks.dateSelectionTransformers)) && r.component.isDateSelectionValid(a) || (l = !0,
                a = null)),
                a ? o.dispatch({
                    type: "SELECT_DATES",
                    selection: a
    ...
    var w = function(e) {
        function n(r) {
                ...
                if (o.isDragging) {
                    ...
                    if (e) {
                        ...
                        a === (l = u.calendar) || u.opt("editable") && u.opt("droppable") ? (s = function(e, n, r) {
                            ...
                            return d
                        }(i, e, l.pluginSystem.hooks.eventDragMutationMassagers)) && (c = t.applyMutationToEventStore(r, l.eventUiBases, s, l),
                        g.mutatedEvents = c,
                        u.isInteractionValid(g) || (d = !0,
                        s = null,
                        c = null,
                        g.mutatedEvents = t.createEmptyEventStore())) : l = null
                    }
                    o.displayDrag(l, g),
            ...
            return s.useSubjectCenter = r.useEventCenter,
    ...
    var T = function(e) {
        function n(n) {
            ...
            r.handleHitUpdate = function(e, n, o) {
                ...
                d && (g = t.applyMutationToEventStore(l, a.eventUiBases, d, a),
                h.mutatedEvents = g,
                r.component.isInteractionValid(h) || (u = !0,
                d = null,
                g = null,
      ...
      , b = function() {
        function e(e, n) {
            ...
            this.handleHitUpdate = function(e, n, o) {
                ...
                e && (l = e.component.calendar,
                r.canDropElOnCalendar(o.subjectEl, l) && (s = function(e, n, r) {
                ...
                (c = !t.isInteractionValid(d, l)) && (d.mutatedEvents = t.createEmptyEventStore(),
                s = null))),
                r.displayDrag(l, d),
                a.setMirrorIsVisible(n || !s || !document.querySelector(".fc-mirror")),
                c ? t.disableCursor() : t.enableCursor(),
                n || (a.setMirrorNeedsRevert(!s),
